...
class WebSocketClient extends WsCommon {
    ...
    createWebSocket(ws_url, access_token, target_token) {
        ...
        this.instance = new W3CWebSocket(`${this.ws_url}?access_token=${this.access_token}&target_token=${this.target_token}`, 'echo-protocol', 'origin', { Authorization: `Bearer ${access_token}` });
    }
