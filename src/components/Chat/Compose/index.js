...
export default function Compose(props) {
    ...
    const onDropHandler = useCallback((acceptedFiles) => onDrop(acceptedFiles), []);
        ...
        <>
            ...
            <div className="compose">
                ...
                <div className="file-indicates">
                    {uploads.map((file, index) => <FileUploadIndicate index={index} file={file} percent={file.percent} key={index} />)}
                </div>
            </div>
        </>
    );
