...
export default function Message(props) {
    ...
    return (
        <div
            className={classnames('message-menu', { active: isOpen })}
        >
            <div
                className="message-menu__back"
            ...
            {isMine && <button type="button" onClick={onMessageDelete}>{getLocaleName('deleteMessage')}</button>}
