import qs from 'qs';
import {
    LOGIN, CHECK_AUTH, AUTH_SUCCESS, AUTH_FAILED,
    FETCH_USER_DATA_SUCCESS, FETCH_USER_DATA,
} from '../actions/user';
import { AUTH_STATUS_UNKOWN, AUTH_STATUS_SUCCESS, AUTH_STATUS_FAILED, AUTH_WAITING } from '../../config';
